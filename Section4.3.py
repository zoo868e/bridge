...
def makeDATASET(l, size = 1000):
    shufflelist(l)
    f = open("./data/dataForCofsection43", "w")
...
def main():
    ...
    for _formulaid in range(len(Train_target)):
        ...
        checkerProcess = Popen(['./accuracyChecker', "./data/wholeStaticForC", formulaid], stdin=PIPE, stdout=PIPE)
        best_para = []
        best_hyper = [0, 0, 0]
